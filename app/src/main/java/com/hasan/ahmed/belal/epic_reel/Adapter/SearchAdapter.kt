...
import com.hasan.ahmed.belal.epic_reel.databinding.SearchMoviesBinding
...
class SearchAdapter(
    ...
    class ViewHolder(val binding: SearchMoviesBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = SearchMoviesBinding.inflate(
